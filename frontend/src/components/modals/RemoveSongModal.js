...
const RemoveSongModal = ({ song, onConfirm, onCancel }) => {
    if (!song) return null;
        ...
        <div className="modal-overlay">
            <div className="modal-container">
                ...
                <div className="modal-content">
                    <p className="modal-text-primary">Are you sure you want to remove the song from the catalog?</p>
                    <p className="modal-text-secondary">Doing so will remove it from all of your playlists.</p>
                </div>
